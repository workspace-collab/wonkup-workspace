import { demoWorkspaces } from '../../data/demo-workspaces.js?v=12.2.0';
import { demoProjects } from '../../data/demo-projects.js?v=12.2.0';
import { demoActivities, demoTasks } from '../../data/demo-activities.js?v=12.2.0';
import { demoKanban } from '../../data/demo-kanban.js?v=12.2.0';
import { canvasTemplates } from '../../data/canvas-templates.js?v=12.2.0';
import { canAccessProject, canAccessWorkspace, canViewMaster } from '../utils/permissions.js?v=12.2.0';
