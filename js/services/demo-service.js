import { demoWorkspaces } from '../../data/demo-workspaces.js?v=12.2.1';
import { demoProjects } from '../../data/demo-projects.js?v=12.2.1';
import { demoActivities, demoTasks } from '../../data/demo-activities.js?v=12.2.1';
import { demoKanban } from '../../data/demo-kanban.js?v=12.2.1';
import { canvasTemplates } from '../../data/canvas-templates.js?v=12.2.1';
import { canAccessProject, canAccessWorkspace, canViewMaster } from '../utils/permissions.js?v=12.2.1';
