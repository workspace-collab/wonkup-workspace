...
import { demoActivities, demoTasks } from '../../data/demo-activities.js?v=12.0.0';
import { demoKanban } from '../../data/demo-kanban.js?v=12.0.0';
import { canvasTemplates } from '../../data/canvas-templates.js?v=12.0.0';
import { canAccessProject, canAccessWorkspace, canViewMaster } from '../utils/permissions.js?v=12.0.0';
