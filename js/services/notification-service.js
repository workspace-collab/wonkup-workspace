import { demoNotifications } from '../../data/demo-notifications.js?v=12.0.0';
import { getFirebaseClient, waitForFirebaseAuth } from '../cloud/firebase-client.js?v=12.0.0';
import { canAccessProject, canAccessWorkspace, canViewMaster, isReadOnlyRole } from '../utils/permissions.js?v=12.0.0';
