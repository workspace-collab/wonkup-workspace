import { demoNotifications } from '../../data/demo-notifications.js?v=11.0.1';
import { getFirebaseClient, waitForFirebaseAuth } from '../cloud/firebase-client.js?v=11.0.1';
import { canAccessProject, canAccessWorkspace, canViewMaster, isReadOnlyRole } from '../utils/permissions.js?v=11.0.1';
