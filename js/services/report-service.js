import { ProjectService } from './project-service.js?v=12.2.1';
import { FinanceService } from './finance-service.js?v=12.2.1';
import { DeliverableService } from './deliverable-service.js?v=12.2.1';
import { DemoService } from './demo-service.js?v=12.2.1';
import { buildPortfolioReport, resolveReportPeriod } from '../utils/report-calculations.js?v=12.2.1';
import { canAccessProjectFinance, isInternalUser } from '../utils/permissions.js?v=12.2.1';
