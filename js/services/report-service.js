import { ProjectService } from './project-service.js?v=12.3.0';
import { FinanceService } from './finance-service.js?v=12.3.0';
import { DeliverableService } from './deliverable-service.js?v=12.3.0';
import { DemoService } from './demo-service.js?v=12.3.0';
import { buildPortfolioReport, resolveReportPeriod } from '../utils/report-calculations.js?v=12.3.0';
import { canAccessProjectFinance, isInternalUser } from '../utils/permissions.js?v=12.3.0';
