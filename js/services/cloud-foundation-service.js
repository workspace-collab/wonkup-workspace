import { API_CONFIG, firebaseConfigStatus } from '../config/api-config.js?v=12.2.1';
import { getFirebaseClient, waitForFirebaseAuth } from '../cloud/firebase-client.js?v=12.2.1';
import { getFirebaseSdkUrls } from '../cloud/firebase-sdk-loader.js?v=12.2.1';
import { buildFoundationMigrationPlan, getLocalFoundationSnapshot } from '../cloud/migration-plan.js?v=12.2.1';
import { buildUserActivationPlan } from '../cloud/user-activation-plan.js?v=12.2.1';
import { buildKanbanMigrationPlan, getLocalKanbanSnapshot } from '../cloud/kanban-migration-plan.js?v=12.2.1';
import { buildDeliverableMigrationPlan, getLocalDeliverableSnapshot } from '../cloud/deliverable-migration-plan.js?v=12.2.1';
import { buildCanvasMigrationPlan, getLocalCanvasSnapshot } from '../cloud/canvas-migration-plan.js?v=12.2.1';
