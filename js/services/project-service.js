...
import { MockProjectAdapter } from '../adapters/mock-project-adapter.js?v=11.0.0';
import { AppsScriptProjectAdapter } from '../adapters/apps-script-project-adapter.js?v=11.0.0';
import { FirebaseProjectAdapter } from '../adapters/firebase-project-adapter.js?v=11.0.0';
