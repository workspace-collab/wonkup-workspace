...
import { MockProjectAdapter } from '../adapters/mock-project-adapter.js?v=12.0.1';
import { AppsScriptProjectAdapter } from '../adapters/apps-script-project-adapter.js?v=12.0.1';
import { FirebaseProjectAdapter } from '../adapters/firebase-project-adapter.js?v=12.0.1';
