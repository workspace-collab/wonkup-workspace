...
import { MockAccessAdapter } from '../adapters/mock-access-adapter.js?v=12.0.0';
import { AppsScriptAdapter } from '../adapters/apps-script-adapter.js?v=12.0.0';
import { FirebaseAccessAdapter } from '../adapters/firebase-access-adapter.js?v=12.0.0';
import { demoAccessGrants } from '../../data/demo-access.js?v=12.0.0';
