...
import { MockAccessAdapter } from '../adapters/mock-access-adapter.js?v=11.0.1';
import { AppsScriptAdapter } from '../adapters/apps-script-adapter.js?v=11.0.1';
import { FirebaseAccessAdapter } from '../adapters/firebase-access-adapter.js?v=11.0.1';
