...
import { KanbanService } from './kanban-service.js?v=11.0.1';
import { canvasTemplates } from '../../data/canvas-templates.js?v=11.0.1';
import { CanvasService } from './canvas-service.js?v=11.0.1';
import { DeliverableService } from './deliverable-service.js?v=11.0.1';
import { isReadOnlyRole } from '../utils/permissions.js?v=11.0.1';
