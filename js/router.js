const routes = [
  ...
  { pattern: /^#\/master\/users$/, view: 'usersAdmin', params: { workspaceId: 'all' } },
  { pattern: /^#\/master\/ai$/, view: 'aiAdmin', params: { workspaceId: 'all' } },
  ...
  { pattern: /^#\/w\/([^/]+)\/reports$/, view: 'reports', keys: ['workspaceId'] },
  { pattern: /^#\/w\/([^/]+)\/(calendar|team|documents|settings)$/, view: 'placeholder', keys: ['workspaceId', 'section'] },
