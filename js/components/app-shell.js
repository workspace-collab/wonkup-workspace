...
import { DemoService } from '../services/demo-service.js?v=11.0.1';
import { AccessService } from '../services/access-service.js?v=11.0.1';
import { NotificationService } from '../services/notification-service.js?v=11.0.1';
import { GlobalSearchService } from '../services/global-search-service.js?v=11.0.1';
import { getState, setState, clearSession } from '../state/store.js?v=11.0.1';
import { showToast } from './toast.js?v=11.0.1';
import { confirmModal } from './modal.js?v=11.0.1';
import { escapeHtml } from '../utils/format.js?v=11.0.1';
import { closePopovers, initializePopoverManager, togglePopover } from '../utils/popover-manager.js?v=11.0.1';
import { canCreateProject, canManageCloudFoundation, canViewMaster, isInternalUser, isReadOnlyRole } from '../utils/permissions.js?v=11.0.1';
    ...
    <div class="sidebar-inner">
      ...
      <nav class="sidebar-nav" aria-label="Navegación principal">
        ${navItems.map((item, index) => {
          ...
          const divider = index === navItems.length - 1 && key === 'settings' ? '<div class="nav-group-title">Administración</div>' : '';
