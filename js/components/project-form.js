...
import { getState } from '../state/store.js?v=12.4.0';
import { escapeHtml } from '../utils/format.js?v=12.4.0';
import { isValidEmail, normalizeAssetUrl, normalizeProjectInput, normalizeText, normalizeUrl, validateProjectInput } from '../utils/validation.js?v=12.4.0';
import { canManageClients } from '../utils/permissions.js?v=12.4.0';
import { openModal } from './modal.js?v=12.4.0';
