...
import { getState } from '../state/store.js?v=12.0.1';
import { escapeHtml } from '../utils/format.js?v=12.0.1';
import { isValidEmail, normalizeAssetUrl, normalizeProjectInput, normalizeText, normalizeUrl, validateProjectInput } from '../utils/validation.js?v=12.0.1';
import { canManageClients } from '../utils/permissions.js?v=12.0.1';
import { openModal } from './modal.js?v=12.0.1';
