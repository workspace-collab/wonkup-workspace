import { createAppShell, renderShell } from './components/app-shell.js?v=9.0.5';
import { startRouter } from './router.js?v=9.0.5';
import { getState, subscribe, setState, setSession, clearSession } from './state/store.js?v=9.0.5';
import { AccessService } from './services/access-service.js?v=9.0.5';
import { canAccessRoute, canAccessWorkspace, getDefaultRoute } from './utils/permissions.js?v=9.0.5';
import { renderAccess } from './views/access-view.js?v=9.0.5';
import { renderForbidden } from './views/forbidden-view.js?v=9.0.5';
import { renderDashboard } from './views/dashboard-view.js?v=9.0.5';
import { renderProjects } from './views/projects-view.js?v=9.0.5';
import { renderProject } from './views/project-view.js?v=9.0.5';
import { renderToolkit, cleanupToolkitView } from './views/toolkit-view.js?v=9.0.5';
import { renderCanvas, renderSharedCanvas, cleanupCanvasView } from './views/canvas-view.js?v=9.0.5';
import { renderKanban, cleanupKanbanView } from './views/kanban-view.js?v=9.0.5';
import { renderPlaceholder } from './views/placeholder-view.js?v=9.0.5';
import { renderClients } from './views/clients-view.js?v=9.0.5';
import { renderClientPortal } from './views/client-portal-view.js?v=9.0.5';
import { renderReports, cleanupReportsView } from './views/reports-view.js?v=9.0.5';
import { renderCloudFoundation, cleanupCloudFoundationView } from './views/cloud-foundation-view.js?v=9.0.5';
