import { createAppShell, renderShell } from './components/app-shell.js?v=9.0.4';
import { startRouter } from './router.js?v=9.0.4';
import { getState, subscribe, setState, setSession, clearSession } from './state/store.js?v=9.0.4';
import { AccessService } from './services/access-service.js?v=9.0.4';
import { canAccessRoute, canAccessWorkspace, getDefaultRoute } from './utils/permissions.js?v=9.0.4';
import { renderAccess } from './views/access-view.js?v=9.0.4';
import { renderForbidden } from './views/forbidden-view.js?v=9.0.4';
import { renderDashboard } from './views/dashboard-view.js?v=9.0.4';
import { renderProjects } from './views/projects-view.js?v=9.0.4';
import { renderProject } from './views/project-view.js?v=9.0.4';
import { renderToolkit, cleanupToolkitView } from './views/toolkit-view.js?v=9.0.4';
import { renderCanvas, renderSharedCanvas, cleanupCanvasView } from './views/canvas-view.js?v=9.0.4';
import { renderKanban, cleanupKanbanView } from './views/kanban-view.js?v=9.0.4';
import { renderPlaceholder } from './views/placeholder-view.js?v=9.0.4';
import { renderClients } from './views/clients-view.js?v=9.0.4';
import { renderClientPortal } from './views/client-portal-view.js?v=9.0.4';
import { renderReports, cleanupReportsView } from './views/reports-view.js?v=9.0.4';
import { renderCloudFoundation, cleanupCloudFoundationView } from './views/cloud-foundation-view.js?v=9.0.4';
