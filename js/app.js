import { createAppShell, renderShell } from './components/app-shell.js?v=10.0.0';
...
import { renderProject } from './views/project-view.js?v=10.0.0';
...
import { renderKanban, cleanupKanbanView } from './views/kanban-view.js?v=10.0.0';
