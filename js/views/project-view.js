...
import { escapeHtml, formatDate, formatCurrency } from '../utils/format.js?v=11.0.1';
import { isValidEmail, normalizeText, normalizeUrl } from '../utils/validation.js?v=11.0.1';
import { renderKanban } from './kanban-view.js?v=11.0.1';
import { renderToolkit } from './toolkit-view.js?v=11.0.1';
import { renderDeliverables } from './deliverables-view.js?v=11.0.1';
import { openProjectForm } from '../components/project-form.js?v=11.0.1';
import { confirmModal, openModal } from '../components/modal.js?v=11.0.1';
...
function renderTab(slot, project, tab, session) {
  const renderers = {
    ...
    finance: async () => {
      ...
      try {
        const module = await import('./finance-view.js?v=11.0.1');
