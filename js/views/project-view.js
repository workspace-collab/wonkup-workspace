...
import { escapeHtml, formatDate, formatCurrency } from '../utils/format.js?v=12.5.0';
import { isValidEmail, normalizeText, normalizeUrl } from '../utils/validation.js?v=12.5.0';
import { renderKanban } from './kanban-view.js?v=12.5.0';
import { renderToolkit } from './toolkit-view.js?v=12.5.0';
import { renderDeliverables } from './deliverables-view.js?v=12.5.0';
import { openProjectForm } from '../components/project-form.js?v=12.5.0';
import { confirmModal, openModal } from '../components/modal.js?v=12.5.0';
...
function renderTab(slot, project, tab, session) {
  const renderers = {
    ...
    finance: async () => {
      ...
      try {
        const module = await import('./finance-view.js?v=12.5.0');
