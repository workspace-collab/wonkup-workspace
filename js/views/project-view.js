...
import { escapeHtml, formatDate, formatCurrency } from '../utils/format.js?v=9.0.5';
import { isValidEmail, normalizeText, normalizeUrl } from '../utils/validation.js?v=9.0.5';
import { renderKanban } from './kanban-view.js?v=9.0.5';
import { renderToolkit } from './toolkit-view.js?v=9.0.5';
import { renderDeliverables } from './deliverables-view.js?v=9.0.5';
import { openProjectForm } from '../components/project-form.js?v=9.0.5';
import { confirmModal, openModal } from '../components/modal.js?v=9.0.5';
...
function renderTab(slot, project, tab, session) {
  const renderers = {
    ...
    finance: async () => {
      ...
      try {
        const module = await import('./finance-view.js?v=9.0.5');
