...
import { canCommentKanban, canConfigureKanban, canDeleteKanbanCard, canEditKanban } from '../utils/permissions.js?v=11.0.0';
import { KANBAN_TONES, kanbanTemplates } from '../../data/kanban-templates.js?v=11.0.0';
import { icon } from '../utils/icons.js?v=11.0.0';
import { escapeHtml, formatDate } from '../utils/format.js?v=11.0.0';
import { openModal, closeModal, confirmModal } from '../components/modal.js?v=11.0.0';
