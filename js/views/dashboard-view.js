import { ReportService } from '../services/report-service.js?v=12.5.0';
import { canViewFinancials } from '../utils/permissions.js?v=12.5.0';
import { icon } from '../utils/icons.js?v=12.5.0';
import { escapeHtml, formatCurrency, formatDate } from '../utils/format.js?v=12.5.0';
