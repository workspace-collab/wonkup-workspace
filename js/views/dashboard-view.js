...
export function renderDashboard(container, workspaceId, session) {
  ...
  const avgProgress = projects.length
    ...
    : 0;
  const budget = projects.reduce((total, project) => total + project.budget, 0);
