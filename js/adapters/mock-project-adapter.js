...
import { demoClients } from '../../data/demo-clients.js?v=12.4.0';
import { demoProjectMembers } from '../../data/demo-project-members.js?v=12.4.0';
import { demoResources } from '../../data/demo-resources.js?v=12.4.0';
import { demoMilestones } from '../../data/demo-milestones.js?v=12.4.0';
import { demoUsers } from '../../data/demo-users.js?v=12.4.0';
