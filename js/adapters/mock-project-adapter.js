import { demoProjects } from '../../data/demo-projects.js?v=12.0.1';
import { demoClients } from '../../data/demo-clients.js?v=12.0.1';
import { demoProjectMembers } from '../../data/demo-project-members.js?v=12.0.1';
import { demoResources } from '../../data/demo-resources.js?v=12.0.1';
import { demoMilestones } from '../../data/demo-milestones.js?v=12.0.1';
import { demoUsers } from '../../data/demo-users.js?v=12.0.1';
import { demoWorkspaces } from '../../data/demo-workspaces.js?v=12.0.1';
import {
  canAccessProject,
  canAccessWorkspace,
  canArchiveProject,
