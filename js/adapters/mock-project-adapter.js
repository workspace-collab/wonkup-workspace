...
import { demoClients } from '../../data/demo-clients.js?v=11.0.1';
import { demoProjectMembers } from '../../data/demo-project-members.js?v=11.0.1';
import { demoResources } from '../../data/demo-resources.js?v=11.0.1';
import { demoMilestones } from '../../data/demo-milestones.js?v=11.0.1';
