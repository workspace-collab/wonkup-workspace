...
import { getCanvasTemplate } from '../../data/canvas-templates.js?v=12.0.1';
import { demoUsers } from '../../data/demo-users.js?v=12.0.1';
import { canAccessProject, canDeleteCanvas, canEditCanvas, canManageCanvas } from '../utils/permissions.js?v=12.0.1';
