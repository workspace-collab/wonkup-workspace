import { demoCanvasInstances } from '../../data/demo-canvases.js?v=11.0.0';
import { getCanvasTemplate } from '../../data/canvas-templates.js?v=11.0.0';
import { demoUsers } from '../../data/demo-users.js?v=11.0.0';
import { canAccessProject, canDeleteCanvas, canEditCanvas, canManageCanvas } from '../utils/permissions.js?v=11.0.0';
