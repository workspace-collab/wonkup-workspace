...
with sync_playwright() as p:
    ...
    assert page.locator('.canvas-build-version').inner_text()=='Motor 5.7.0'
    ...
    page.fill('[data-draft-note] .canvas-inline-note-input','Nota rápida 5.7')
    ...
    quick_note=page.locator('.canvas-note[data-note-id]').filter(has_text='Nota rápida 5.7')
    quick_note.hover()
    ...
    page.screenshot(path=str(root/'tests'/'canvas-ux-smoke-5-7.png'),full_page=True)
    browser.close()
print('CANVAS_UX_5_7_OK')
